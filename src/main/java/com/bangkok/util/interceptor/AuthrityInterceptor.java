...
//		authMap.put("/planAjax/planDelete.do", 1);
		...
		// 호텔 예약 & 리뷰 & 이벤트 권한 처리 
		//호텔 예약 권한
		authMap.put("/hotel_reservations/adminList.do", 9);
		authMap.put("/hotel_reservations/view.do", 1);
		authMap.put("/hotel_reservations/writeForm.do", 1);
		authMap.put("/hotel_reservations/changeStatus.do", 9);
		authMap.put("/hotel_reservations/delete.do", 1);
		authMap.put("/hotel_reservationsRest", 1);
		//리뷰 권한
		authMap.put("/reviews/view.do", 1);
		authMap.put("/reviews/write.do", 1);
		authMap.put("/reviews/count.do", 1);
		authMap.put("/reviews/delete.do", 1);
		//이벤트 권한
		...
		authMap.put("/event/categoryWrite.do", 9);
		authMap.put("/event/categoryUpdate.do", 9);
		authMap.put("/event/categoryDelete.do", 9);
	}
