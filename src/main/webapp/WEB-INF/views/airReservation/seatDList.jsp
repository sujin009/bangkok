	...
	<div class="container-fluid">
		<div style="border-bottom: 1px solid #e0e0e0;" class="mb-3">
			<ul class="nav nav-pills nav-justified">
				...
				<li class="nav-item"><a class="nav-link active"
					href="/seat/seatAlist.do">오는편</a></li>
			</ul>
		</div>
		...
		<div class="row">
			...
			<div class="col-sm-7">
				...
				<div class="box">
					...
					<div class="row binder">
						<div class="col toilet-box"></div>
						<div class="col toilet-box"></div>
						<div class="col-2 toilet-box toilet">
			...
			<div class="col-sm-3">
				<div class="passenger-info">
					<h5>
						...
						<p>항공사: ${reservation[0].airlinekor} (${vo.airlineEng})</p>
				...
				<form action="seatReservationD.do" method="post">
					<h3>좌석 선택</h3>
					<input type="hidden" name="reservationNo" value="${reservation[0].reservationNo }">
						
					<div class="seatInputs" style="display: none;"></div>
					...
					<button class="btn btn-warning" type="submit">오는편 좌석 선택하러 가기</button>
				</form>
			</div>
		</div>
	</div>
