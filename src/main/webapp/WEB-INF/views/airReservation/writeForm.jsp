...
$(function () {
	...
	// 성인은 현재일보다 19년 전까지로 생일을 지정가능 
            ...
            let child_PassportmaxDate = new Date(today.getFullYear() + 5, today.getMonth(), today.getDate());
            ...
            // 아동 여권 Datepicker 초기화
            $(".child_passport_datepicker").datepicker({
                changeMonth: true,
                changeYear: true,
                dateFormat: "yy-mm-dd",
                minDate: today,
                maxDate: child_PassportmaxDate
            });
					    ...
					    <div class="passenger-info-container">
							    ...
							    <div class="passenger-item" style="margin-bottom: 20px;">
							        ...
							        <div class="input-group" style="display: flex; justify-content:start; margin-bottom: 15px;">
							            ...
							            <div style="width: 100px; margin-left: 30px;">
							                ...
							                <input class="adult_passport_datepicker" id="passport-expiry-${i}-a" name="apassengers[${i-1}].passportEndDate" style="width: 100%;">
							            </div>
							        </div>
							    </div>
							</c:forEach>
							...
							<c:forEach var="i" begin="1" end="${param.cPassenger}">
								 <div class="passenger-item" style="margin-bottom: 20px;">
							        ...
							        <div class="input-group" style="margin-bottom: 15px;">
							            <label for="birth-${i}-a">생일</label>
							            <div style="display: flex; justify-content: space-between; gap: 10px;">
							                <input class="child_datepicker" name="cpassengers[${i-1}].birth" id="dob-${i}-c">
							            </div>
							        </div>
							        ...
							        <div class="input-group" style="display: flex; justify-content: start; margin-bottom: 15px;">
							            ...
							            <div style="width: 100px; margin-left: 30px;">
							                <label for="passport-expiry-${i}-a">여권 만료일</label>
							                <input class="child_passport_datepicker" id="passport-expiry-${i}-c" name="cpassengers[${i-1}].passportEndDate" style="width: 100%;">
							            </div>
							        </div>
							    </div>
							</c:forEach>
							<c:forEach var="i" begin="1" end="${param.iPassenger}">
								<div class="passenger-item" style="margin-bottom: 20px;">
							        ...
							        <div class="input-group" style="margin-bottom: 15px; width: 100%;">
							            <label for="nationality-${i}-a">국적</label>
							            <select class="form-control nationality-${i}" name="ipassengers[${i-1}].nationality" id="nationality-${i}-i" style="width: 100%;">
							                <!-- ajax를 이용한 중분류 option 로딩하기 -->
							            </select>
							        </div>
							        ...
							        <div class="input-group" style="display: flex; justify-content: start; margin-bottom: 15px;">
							            ...
							            <div style="width: 100px; margin-left: 30px;">
							                <label for="passport-expiry-${i}-a">여권 만료일</label>
							                <input class="infant_passport_datepicker" id="passport-expiry-${i}-i" name="ipassengers[${i-1}].passportEndDate" style="width: 100%;">
							            </div>
							        </div>
							    </div>
							</c:forEach>
