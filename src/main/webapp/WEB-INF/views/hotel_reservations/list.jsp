...
.form-group {
    margin-bottom: 15px;
    padding-left: 10px; /* 왼쪽으로 떨어지게 여백 추가 */
}

label {
    display: block;
    margin-bottom: 8px;
    padding-left: 5px; /* 글씨가 왼쪽으로 떨어지게 조정 */
    font-weight: bold;
}
...
.form-control {
    ...
    margin-left: 5px; /* input 필드가 왼쪽으로 떨어지게 조정 */
}
...
#reviewTitle, #reviewContent {
    width: 95%; /* input과 textarea의 폭 조정 */
...
<body>
	...
	<div class="container">
		...
		<a class="btn btn-outline-primary float-right" href="adminList.do">관리자 리스트
		</a>
		</c:if>
		...
		<div class="row md-5">
			<ul class="nav nav-tabs">
				...
				<li class="nav-item"><a class="nav-link foreignCountry" data-toggle="tab"
